...
func TestUpdateIncrement(t *testing.T) {
	...
	v := sm.Update("k", 0, func(old int, existed bool) int {
		if !existed {
			return 1
		}
		return old + 1
...
func TestUpdateExpiredTreatedAsMissing(t *testing.T) {
	sm := NewSafeMap[int]()
